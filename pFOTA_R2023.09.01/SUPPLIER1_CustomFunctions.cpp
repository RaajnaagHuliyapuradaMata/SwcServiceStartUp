...
static boolean SUPPLIER1_ApplicationCrc32Check(void){
  ...
  ulCrc32 = LibAutosarCrc_CalculateCRC32((Crc_DataRefType)pStartOfApplication, ulLength, 0xFFFFFFFF);
...
uint32 SUPPLIER1_CalcGenealogyBlockCrc32(void){
  ...
  ulCrc32 = LibAutosarCrc_CalculateCRC32((Crc_DataRefType)pGenealogyBlock, (cSTRING_SIZ_FULLGENBLOCK-cSTRING_SIZ_GEN_CRC32), 0x00000000);
