...
#define cSW_VERSION_MAJOR   (uint8)01
#define cSW_VERSION_MINOR   (uint8)00
#define cSW_VERSION_MICRO   (uint16)0001
...
#define SEED_KEY_ALGORITHM  SEED_KEY_USE_AES256_CBC
  ...
  #define DEBUG_PORTS_ACTIVE

  #define DEBUG_IGNORE_MESSAGE_AUTHENTICATION

  #define SMART_TESTER_JUMP_IN
#endif
...
#define cSTRING_SIZ_GEN_CRC32    4
...
extern void VERSION_SyncPartnumber_315_433_from_Flash_to_Flash(void);
